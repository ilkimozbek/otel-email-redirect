...
app.get('/', async function(req, res) {
    ...
    const address_3 = 'ilkim.ozbek@kafessizturkiye.org'
    
    const subjects = ['kafese hayır', 'eziyete karşıyım','kafes eziyetine karşıyım', 'Kafeslere Hayır', 'Kafesleri terk edin',
    'Yumurta kullanımınız', 'Kafeslere hayır', 'kafese son', 'Eziyet son bulsun', 'Hayvan eziyeti', 'hayvan eziyeti', 'eziyet bitsin','taahhüt',' ', ' ', ' ']
